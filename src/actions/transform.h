...
#ifndef MASCOT_ACTION_TRANSFORM_H
#define MASCOT_ACTION_TRANSFORM_H
...
// enum mascot_tick_result transform_action_tick(struct mascot *mascot, struct mascot_action_reference *actionref, uint32_t tick);
